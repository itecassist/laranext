    ...
    <x-authentication-card>
        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div class="mt-4">
                ...
                <x-input id="title" class="block mt-1 w-full" type="text" name="title" :value="old('title')" required autofocus autocomplete="last_name" />
            </div>
            <div class="mt-4">
                <x-label for="first_name" value="{{ __('auth.first_name') }}" />
                <x-input id="first_name" class="block mt-1 w-full" type="text" name="first_name" :value="old('first_name')" required autofocus autocomplete="last_name" />
            </div>
            <div class="mt-4">
            ...
            <div class="mt-4">
                ...
                <x-input id="mobile_phone" class="block mt-1 w-full" type="text" name="mobile_phone" required autocomplete="mobile_phone" />
            </div>

            <div class="mt-4">
                <x-label for="gender" value="{{ __('auth.gender') }}" />
                <x-input id="gender" class="block mt-1 w-full" type="text" name="gender" required autocomplete="gender" />
            </div>
            <div class="mt-4">
                <x-label for="date_of_birth" value="{{ __('auth.date_of_birth') }}" />
                <x-input id="date_of_birth" class="block mt-1 w-full" type="text" name="date_of_birth" required autocomplete="date_of_birth" />
            </div>
            ...
            <hr class="m-4" />
            <div class="w-full flex justify-center mx-2 mt-3">
